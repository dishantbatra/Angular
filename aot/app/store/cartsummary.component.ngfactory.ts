...
export class View_CartSummaryComponent0 extends import1.AppView<import0.CartSummaryComponent> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_22:any = (this.context.cart.itemCount == 0);
...
class View_CartSummaryComponent1 extends import1.AppView<any> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    valUnwrapper.reset();
    const currVal_2:any = import3.inlineInterpolate(2,'\n            ',this.parentView.context.cart.itemCount,' item(s) ',valUnwrapper.unwrap(import3.castByValue(this._pipe_currency_0_0,(<View_CartSummaryComponent0>this.parentView)._pipe_currency_0.transform)(this.parentView.context.cart.cartPrice,'USD',true,'2.2-2')),'\n        ');
