...
export class View_ProductEditorComponent0 extends import1.AppView<import0.ProductEditorComponent> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_71:any = this.context.editing;
    ...
    const currVal_72:any = import3.inlineInterpolate(1,'',(this.context.editing? 'Edit': 'Create'),' Product');
    ...
    const currVal_73:any = this.context.editing;
    ...
    const currVal_74:any = import3.inlineInterpolate(1,'\n        ',(this.context.editing? 'Save': 'Create'),'\n    ');
